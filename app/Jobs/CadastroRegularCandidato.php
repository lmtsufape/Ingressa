        ...
        foreach ($records as $record) {
            ...
            if (!$candidato) { 
                ...
                $candidatosData[] = [
                    ...
                    'dt_nascimento' => date('Y/m/d', strtotime($record['DT_NASCIMENTO'])),
            ...
            $inscricoesData[] = [
                ...
                'dt_operacao' => !empty($record['DT_OPERACAO']) ? date('Y/m/d', strtotime($record['DT_OPERACAO'])) : null,
                ...
                'dt_curso_inscricao' => !empty($record['DT_CURSO_INSCRICAO']) ? date('Y/m/d', strtotime($record['DT_CURSO_INSCRICAO'])) : null,
                'hr_curso_inscricao' => $record['HR_CURSO_INSCRICAO'],
                'dt_mes_dia_inscricao' => !empty($record['DT_MES_DIA_INSCRICAO']) ? date('Y/m/d', strtotime($record['DT_MES_DIA_INSCRICAO'])) : null,
                ...
                'dt_mes_dia_matricula' => !empty($record['DT_MES_DIA_MATRICULA']) ? date('Y/m/d', strtotime($record['DT_MES_DIA_MATRICULA'])) : null,
                'st_matricula_cancelada' => $record['ST_MATRICULA_CANCELADA'],
                'dt_matricula_cancelada' => !empty($record['DT_MATRICULA_CANCELADA']) ? date('Y/m/d', strtotime($record['DT_MATRICULA_CANCELADA'])) : null,
