...
class DownloadTodosDocumentosCandidatosJob implements ShouldQueue
{
    ...
    {
        $curso = Curso::find($this->curso_id)->get(['nome'])->with('getTurno');
        ...
        event(new ZipGerado($this->userId, $downloadUrl));
