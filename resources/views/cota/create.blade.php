            ...
            <div class="col-md-10">
                <div class="card" style="width: 100%;">
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col-md-8">
                                <h5 class="card-title">Criar uma nova cota</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Cotas > Criar cota</h6>
                            </div>
                        </div>
                        <form id="criar-curso-form" method="POST" action="{{route('cotas.store')}}">
                            @csrf
                            <div class="form-row">
