<x-app-layout>
    <div class="fundo2 px-5">
        ...
        <div class="container">
                    ...
                    <div class="col-md-12">
                        @if ($inscricao->cd_efetivado == \App\Models\Inscricao::STATUS_VALIDACAO_CANDIDATO['cadastro_invalidado_confirmacao'])
                            <div class="alert alert-warning fade show" role="alert">
                                <strong>Atenção!</strong> O Candidato teve o cadastro invalidado! Confirme se o candidato
                                realmente deve ter o cadastro invalidado.<br>
                                <strong>Justificativa:</strong> {!! $inscricao->justificativa !!}<br>
                                <form method="post" id="confirmar-invalidacao-candidato"
                                    action="{{ route('inscricao.confirmar.invalidacao', ['sisu_id' => $inscricao->chamada->sisu->id, 'chamada_id' => $inscricao->chamada->id, 'curso_id' => $inscricao->curso->id]) }}">
                                    @csrf
                                    <input type="hidden" name="inscricaoID" value="{{ $inscricao->id }}">
                                    <input type="hidden" name="curso" value="{{ $inscricao->curso->id }}">
                                    <input type="hidden" name="confirmarInvalidacao" id="confirmarInvalidacao"
                                        value="">
                                    <div class="row justify-content-between mt-4" style="text-align: center">
                                        <div id ="negarInvalidacao" class="col-md-6 form-group">
                                            <button type="submit" class="btn botaoVerde my-2 py-1"
                                                onclick="atualizarInputConfirmarInvalidacao(false)"><span class="px-4"
                                                    style="font-weight: bolder;">Desfazer invalidação</span></button>
                                        </div>
                                        <div id ="confirmarInvalidacao" class="col-md-6 form-group">
                                            <button type="submit" class="btn botaoVerde my-2 py-1"
                                                style="background-color: #FC605F;"
                                                onclick="atualizarInputConfirmarInvalidacao(true)"><span class="px-4"
                                                    style="font-weight: bolder;">Confirmar invalidação</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            @endcan
            <div class="pb-3">
                <span style="color: #373737; font-size: 17px; font-weight: 700;"><a
                        href="{{ route('sisus.show', ['sisu' => $chamada->sisu->id]) }}"
                        style="text-decoration: none; color: #373737;"> SiSU {{ $chamada->sisu->edicao }}</a> > <a
                        href="{{ route('chamadas.candidatos', ['sisu_id' => $chamada->sisu->id, 'chamada_id' => $chamada->id]) }}"
                        style="text-decoration: none; color: #373737;"> Candidatos da {{ $chamada->nome }}</a> > <a
                    ...
                    <div style="border-radius: 0.5rem;" class="col-md-12 p-0 shadow">
                        <div class="cabecalhoAzul p-2 px-3 align-items-center">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-md-10">
                                    <button title="Carregar ficha cadastral" onclick="carregarFicha()"
                                        style="cursor:pointer;"><img src="{{ asset('img/Grupo 1662.svg') }}"
                                            alt="" width="40" class="img-flex"
                                            alt="Icone de ficha cadastral"></button>

                                    <label class="tituloTabelas ps-1" id="nomeDoc">Ficha Geral</label>
                                </div>
                                <div class="col-md-2" style="text-align: right">
                                    <button title="Documento anterior"
                                        onclick="carregarProxDoc({{ $inscricao->id }}, -1)"
                                        style="cursor:pointer;"><img width="30"
                                            src="{{ asset('img/Icon ionic-ios-arrow-dropleft-circle.svg') }}"></button>
                                    <button title="Próximo documento"
                                        onclick="carregarProxDoc({{ $inscricao->id }}, 1)" style="cursor:pointer;"><img
                                            width="30"
                                            src="{{ asset('img/Icon ionic-ios-arrow-dropright-circle.svg') }}"></button>
                                </div>
                            </div>
                        </div>
                        <div class="corpo" id="mensagemVazia" class="text-center" style="display: none;">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <p id="aguardandoTexto"
                                        style="font-weight: bolder; font-size: 18px; padding-top: 10px;">O candidato
                                        informou que:</p>
                                </div>
                            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" checked disabled
                                            id="checkboxCaixa">
                                        <label class="form-check-label" id="caixaTexto"
                                            style="font-weight: bolder; font-size: 18px;" for="checkboxCaixa">
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-md-6">
                                        <a href="{{ route('chamadas.candidatos.curso', ['sisu_id' => $inscricao->chamada->sisu->id, 'chamada_id' => $inscricao->chamada->id, 'curso_id' => $inscricao->curso->id]) }}"
                                            type="button" class="btn botao my-2 py-1 col-md-5"><span
                        ...
                        <div class="corpo p-3" style="display: none;">
                            <div class="d-flex align-items-center my-2 pt-1 pb-3">
                                <iframe width="100%" height="700" frameborder="0" allowtransparency="true"
                                    id="documentoPDF" src=""></iframe>
                            </div>
                            <div id="motivo-reprovacao" style="display: none" class="col-md-12 alert alert-danger"
                                role="alert">
                            </div>
                            <div id="motivo-aprovacao" style="display: none" class="col-md-12 alert alert-success"
                                role="alert">
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row justify-content-end">
                                                <button data-bs-toggle="modal"
                                                    data-bs-target="#avaliar-documento-modal" id="raprovarBotao"
                                                    style="background-color: #FC605F;"
                                                    class="me-1 btn botao my-2 py-1 col-md-5"
                                                    onclick="atualizarInputReprovar();CKEDITOR.instances.comentario.setData( '', function() { this.updateElement();})">
                                                    <span class="px-3 text-center">Recusar</span></button>
                                                <button data-bs-toggle="modal"
                                                    data-bs-target="#avaliar-documento-modal" id="aprovarBotao"
                                                    class="btn botaoVerde my-2 py-1 col-md-5"
                                                    onclick="atualizarInputAprovar();CKEDITOR.instances.comentario.setData( '', function() { this.updateElement();})"><span
                                                        class="px-3 text-center">Aprovar</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="corpo p-3" id="corpoFicha">
                        <div class="d-flex align-items-center my-2 pt-1 pb-3">
                            <div style="border-radius: 0.5rem;" class="shadow">
                                <img class="aling-middle" width="130"
                                    src="@if ($inscricao->arquivo('foto')) {{ route('inscricao.arquivo', [$inscricao->id, 'foto']) }} @else{{ asset('img/foto_geral.svg') }} @endif"
                                    alt="icone-busca">
                            </div>
                            <div class="">
                                ...
                                <div class="tituloDocumento mx-3 pt-1">
                                    Data de Nascimento: <p class="nomeDocumento" style="display: inline">
                                        {{ date('d/m/Y', strtotime($inscricao->candidato->dt_nascimento)) }}</p>
                                </div>
                                <div class="tituloDocumento mx-3 pt-1">
                                    Sexo: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->tp_sexo == 'M' ? 'Masculino' : 'Feminino' }}</p>
                                </div>
                                <div class="tituloDocumento mx-3 pt-1">
                                    Estado Civil: @isset($inscricao->candidato->estado_civil)
                                        <p class="nomeDocumento" style="display: inline">
                                            {{ \App\Models\Candidato::ESTADO_CIVIL[$inscricao->candidato->estado_civil] }}
                                        </p>
                                    @endisset
                                </div>
                                <div class="tituloDocumento mx-3 pt-1">
                                    CPF: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->nu_cpf_inscrito }}</p>
                                </div>
                                <div class="tituloDocumento mx-3 pt-1">
                        ...
                        <div class="col-md-12 py-3 px-3" style="border-bottom: 2px solid #f5f5f5;">
                            <div class="row">
                                <div class="col-md-5 tituloDocumento">
                                    Orgão expedidor: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->orgao_expedidor }}</p>
                                </div>
                                <div class="col-md-3 tituloDocumento">
                                    UF: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->uf_rg }}</p>
                                </div>
                            ...
                            <div class="row pt-2">
                                <div class="col-md-5 tituloDocumento">
                                    Título Eleitoral: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->titulo }}</p>
                                </div>
                                <div class="col-md-3 tituloDocumento">
                                    Zona: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->zona_eleitoral }}</p>
                                </div>
                                <div class="col-md-3 tituloDocumento">
                                    Seção: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->secao_eleitoral }}</p>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-5 tituloDocumento">
                                    Naturalidade: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->cidade_natal }}</p>
                                </div>
                                <div class="col-md-3 tituloDocumento">
                                    UF: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->uf_natural }}</p>
                                </div>
                                <div class="col-md-3 tituloDocumento">
                                    País: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->pais_natural }}</p>
                                </div>
                            </div>
                            <div class="col-md-12 pt-2 tituloDocumento">
                                Nome da Mãe: <p class="nomeDocumento" style="display: inline">
                                    {{ $inscricao->no_mae }}</p>
                            </div>
                            <div class="col-md-12 pt-2 tituloDocumento">
                        ...
                        <div class="col-md-12 py-3 px-3" style="border-bottom: 2px solid #f5f5f5;">
                            <div class="row">
                                <div class="col-md-4 tituloDocumento">
                                    Unidade: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->no_campus }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    Formação: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->ds_formacao }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    Turno: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->ds_turno }}</p>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-4 tituloDocumento">
                                ...
                                <div class="col-md-4 tituloDocumento">
                                    Nota: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->nu_nota_candidato }}</p>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-8 tituloDocumento">
                                    Curso: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->no_curso }}</p>
                                </div>
                                {{-- <div class="col-md-4 tituloDocumento">
                                        Semestre:
                                    </div> --}}
                        ...
                        <div class="col-md-12 py-3 px-3" style="border-bottom: 2px solid #f5f5f5;">
                            <div class="col-md-12 tituloDocumento">
                                Endereço: <p class="nomeDocumento" style="display: inline">
                                    {{ $inscricao->ds_logradouro }}</p>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-4 tituloDocumento">
                                    Número: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->nu_endereco }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    CEP: <p class="nomeDocumento" style="display: inline">{{ $inscricao->nu_cep }}
                                    </p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    Complemento: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->ds_complemento }}</p>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-4 tituloDocumento">
                                    Cidade: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->no_municipio }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    Bairro: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->no_bairro }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    UF: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->sg_uf_inscrito }}</p>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-4 tituloDocumento">
                                    Celular: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->nu_fone1 }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    Celular: <p class="nomeDocumento" style="display: inline">
                            ...
                            <div class="col-md-12 pt-2 tituloDocumento">
                                Email: <p class="nomeDocumento" style="display: inline">
                                    @if ($inscricao->candidato->user->primeiro_acesso == true)
                                        {{ $inscricao->ds_email }}@else{{ $inscricao->candidato->user->email }}
                                    @endif
                                </p>
                            </div>
                        </div>
                        <div class="col-md-12 py-3 px-3" style="border-bottom: 2px solid #f5f5f5;">
                            <div class="col-md-12 tituloDocumento">
                                Estabelecimento que concluiu o Ensino Médio: <p class="nomeDocumento"
                                    style="display: inline">{{ $inscricao->candidato->escola_ens_med }}</p>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-2 tituloDocumento">
                                    UF: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->uf_escola }}</p>
                                </div>
                                <div class="col-md-4 tituloDocumento">
                                    Ano de Conclusão: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->ano_conclusao }}</p>
                                </div>
                                <div class="col-md-6 tituloDocumento">
                                    Modalidade: <p class="nomeDocumento" style="display: inline">
                                        {{ $inscricao->candidato->modalidade }}</p>
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-12 tituloDocumento">
                                    ...
                                    @isset($inscricao->candidato->necessidades)
                                        <p class="nomeDocumento" style="display: inline">
                                            @foreach (explode(',', $inscricao->candidato->necessidades) as $necessidade)
                                                {{ \App\Models\Candidato::NECESSIDADES[$necessidade] }}@if (!$loop->last)
                                                    ,
                                                @endif
                                            @endforeach
                                        </p>
                ...
                <div class="col-md-4">
                        ...
                        @can('isAdmin', \App\Models\User::class)
                            <div style="border-bottom: 1px solid #f5f5f5; line-height: 1.2;"
                                ...
                                <a title="Anexar documentos"
                                    href="{{ route('inscricao.documentacao', $inscricao->id) }}">
                                    <img width="35" src="{{ asset('img/enviar-arquivos.svg') }}"
                                        alt="Icone de anexar documentos"></a>
                                </a>
                                <a title="Baixar todos os documentos do candidato"
                                    href="{{ route('baixar.documentos.candidato', $inscricao->id) }}">
                                    <img width="35" src="{{ asset('img/download1.svg') }}"
                                        alt="Icone de baixar todos os documentos"></a>
                                </a>
                            </div>
                        @else
                        ...
                        @foreach ($documentos as $indice => $documento)
                            ...
                            @elseif($documento == 'comprovante_renda')
                                <div class="row">
                                    <div style="border-bottom: 1px solid #f5f5f5; line-height: 1.2;"
                                        class="d-flex align-items-center justify-content-between pb-2 pt-4">
                                        <div class="d-flex align-items-center">
                                            <span class="tituloTipoDoc">Comprovação da renda familiar bruta mensal per
                                                capita</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @elseif($documento == 'declaracao_cotista')
                                <div class="row">
                                    <div style="border-bottom: 1px solid #f5f5f5; line-height: 1.2;"
                                        class="d-flex align-items-center justify-content-between pb-2 pt-4">
                                        <div class="d-flex align-items-center">
                                            <span class="tituloTipoDoc">Autodeclaração como candidato participante de
                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center justify-content-between pt-3">
                                    ...
                                    @else
                                        <div class="col-md-2">
                                            <a title="Documento não enviado" target="_blank"
                                                style="cursor:pointer;"><img src="{{ asset('img/download3.svg') }}"
                                                    alt="arquivo atual" width="45" class="img-flex"></a>
                                        </div>
                                    @endif
                                    ...
                                    @elseif($documento == 'certificado_conclusao')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Certificado
                                                de Conclusão do Ensino Médio ou Certidão de Exame Supletivo do Ensino
                                                Médio ou Certificação de Ensino Médio através do ENEM ou documento
                                                equivalente;</button>
                                        </div>
                                    @elseif($documento == 'historico')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Histórico
                                                Escolar do Ensino Médio ou equivalente;</button>
                                        </div>
                                    @elseif($documento == 'nascimento_ou_casamento')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                ...
                                                de Nascimento ou Certidão de Casamento;</button>
                                        </div>
                                    @elseif($documento == 'cpf')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Cadastro
                                                de Pessoa Física (CPF) - pode estar no RG;</button>
                                        </div>
                                    @elseif($documento == 'rg')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Carteira
                                                de Identidade (RG) - Frente e verso;</button>
                                        </div>
                                    @elseif($documento == 'quitacao_eleitoral')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Comprovante
                                                de quitação com a Justiça Eleitoral;</button>
                                        </div>
                                    @elseif($documento == 'quitacao_militar')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                ...
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Comprovante
                                                de quitação com o Serviço Militar, para candidatos do sexo masculino que
                                                tenham de 18 a 45 anos - Frente e verso;</button>
                                        </div>
                                    @elseif($documento == 'foto')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Uma
                                                foto 3x4 atual;</button>
                                        </div>
                                    ...
                                    @elseif($documento == 'declaracao_cotista')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Autodeclaração
                                                como candidato participante de reserva de vaga;</button>
                                        </div>
                                    @elseif($documento == 'heteroidentificacao')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Vídeo
                                                individual e recente para procedimento de heteroidentificação;</button>
                                        </div>
                                    @elseif($documento == 'fotografia')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Fotografia
                                                individual e recente para procedimento de heteroidentificação;</button>
                                        </div>
                                    @elseif($documento == 'comprovante_renda')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                ...
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Comprovante
                                                de renda, ou de que não possui renda, de cada membro do grupo familiar,
                                                seja maior ou menor de idade;</button>
                                        </div>
                                    @elseif($documento == 'laudo_medico')
                                        <div class="col-md-10" style="cursor:pointer;">
                                            <button id="nomeDocumento{{ $indice }}" class="nomeDocumento ps-3"
                                                style="display:inline-block; text-align: left;"
                                                for="{{ $documento }}"
                                                onclick="carregarDocumento({{ $inscricao->id }}, '{{ $documento }}', {{ $indice }})">Laudo
                                                médico e exames;</button>
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    @can('isAdminOrAnalistaGeral', \App\Models\User::class)
                        ...
                        <button @if (
                            ...
                            onclick="atualizarInputEfetivar(false)" style="background-color: #FC605F;"> <span
                                class="px-4">
                                @if (is_null($inscricao->cd_efetivado) ||
                                        $inscricao->cd_efetivado == \App\Models\Inscricao::STATUS_VALIDACAO_CANDIDATO['cadastro_validado']
                                )
                                    Invalidar Cadastro
                                @else
                                    Cadastro Invalidado
                    ...
                    @can('isAdminOrHeteroidentificacao', \App\Models\User::class)
                        @if ($inscricao->isCotaRacial() && $inscricao->candidato->isPretoOrPardo())
                            <button id="bloquearHeteroidentificacao" type="button" class="btn botao mt-2 py-1 col-md-12"
                                onclick="bloquearCandidatoInput({{ \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_racial'] }})"
                                style="background-color: #FC605F;"> <span class="px-4">
                                    @if (is_null($inscricao->retificacao) ||
                                            $inscricao->retificacao == \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_medico']
                                    )
                                        Bloquear por não atender aos critérios fenotípicos
                                    @elseif(
                                        $inscricao->retificacao == \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_racial'] ||
                                            $inscricao->retificacao == \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_racial_e_medico']
                                    )
                                        Bloqueado por não atender aos critérios fenotípicos
                                    @endif
                                </span></button>
                        @endif
                    @endcan
                    @can('isAdminOrMedico', \App\Models\User::class)
                        @if ($inscricao->isCotaDeficiencia())
                            <button id="bloquearMedico" type="button" class="btn botao mt-2 py-1 col-md-12"
                                onclick="bloquearCandidatoInput({{ \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_medico'] }})"
                                style="background-color: #FC605F;"> <span class="px-4">
                                    @if (is_null($inscricao->retificacao) ||
                                            $inscricao->retificacao == \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_racial']
                                    )
                                        Bloquear por não atender aos critérios médicos
                                    @elseif(
                                        $inscricao->retificacao == \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_medico'] ||
                                            $inscricao->retificacao == \App\Models\Inscricao::STATUS_RETIFICACAO['bloqueado_motivo_racial_e_medico']
                                    )
                                        Bloqueado por não atender aos critérios médicos
                                    @endif
                                </span></button>
                        @endif
                    @endcan
...
<script>
        ...
        $.ajax({
            ...
            success: function(documento) {
                ...
                if (parseInt(document.getElementById("documento_indice").value) != -1) {
                    document.getElementById("nomeDocumento" + parseInt(document.getElementById(
                        "documento_indice").value)).style.fontWeight = "normal";
                }
                ...
                if (documento.id == null) {
                    if ($("#mensagemVazia").is(":hidden")) {
                        if (documento.nome == "Aguardando o envio do documento.") {
                            ...
                            document.getElementById("aguardandoTexto").innerHTML =
                                "O candidato informou que:";
                    ...
                    if (documento.analisaGeral == true && (documento_nome == "heteroidentificacao" ||
                            documento_nome == "fotografia" || documento_nome == "laudo_medico")) {
                        btnAprovar.disabled = true;
                        btnReprovar.disabled = true;
                    }
    ...
    function atualizarInputAprovar() {
        ...
        if ($('#nomeDoc').text() == getNome('laudo_medico') || $('#nomeDoc').text() == getNome('heteroidentificacao') ||
            $('#nomeDoc').text() == getNome('fotografia')) {
    ...
    function carregarFicha() {
        if (parseInt(document.getElementById("documento_indice").value) != -1) {
            document.getElementById("nomeDocumento" + parseInt(document.getElementById("documento_indice").value)).style
                .fontWeight = "normal";
        }
        atualizarNome("ficha");
