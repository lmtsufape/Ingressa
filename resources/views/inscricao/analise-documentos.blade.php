                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        ...
                        @can('isAdminOrAnalistaGeral', \App\Models\User::class)
                            @if($inscricao->status == \App\Models\Inscricao::STATUS_ENUM['documentos_pendentes'] || $inscricao->status == \App\Models\Inscricao::STATUS_ENUM['documentos_enviados'] || !$inscricao->pertenceAoSisuAtual())
                        ...
                        @can('isAdminOrMedico', \App\Models\User::class)
                            @if($inscricao->isCotaDeficiencia() && $inscricao->pertenceAoSisuAtual())
