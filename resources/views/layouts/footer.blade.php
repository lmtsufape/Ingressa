<footer class="container-fluid pt-1 pb-3">
        ...
        <div class="row justify-content-between align-items-center my-2">
                ...
                <div class="form-row">
                    <div class="col-md-12" style="margin-bottom: 1rem;"> 
                        <div class="row justify-content-center" >
                            <div class="col-md-2"> 
                                <a href="http://ufape.edu.br/" target="_blank"><img src="{{ asset('img/logo_ufape_2023.png') }}" alt="Logo" width="60px;"></a>
                            </div>
                            <div class="col-md-5"> 
            ...
            <div class="col-md-4 text-center pb-4">
                ...
                <div class="row justify-content-center text-center">
                    ...
                    <a href="mailto:lmts@ufape.edu.br" class="col-md-1 p-0"> <img height="30" src="{{asset('img/Icon zocial-email.svg')}}"></a>
                </div>
            </div>
        </div>
        <hr class="m-0 p-0">
