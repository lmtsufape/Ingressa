                ...
                <ul class="navbar-nav ml-auto">
                    @auth
                        ...
                        @if(auth()->user()->role == \App\Models\User::ROLE_ENUM['admin'])
                            ...
                            <li class="nav-item">
                                <a class="nav-link mx-3 @if(request()->routeIs('users.todos')) active @endif" href="{{ route('users.todos') }}"> {{ __('Usuários') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mx-3 @if(request()->routeIs('users.*')) active @endif" href="{{route('users.index')}}">{{ __('Analistas') }}</a>
                            </li>
                            <li class="nav-item">
