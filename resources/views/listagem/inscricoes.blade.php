                ...
                @endphp
                    ...
                    <div class="body">
                        <div id="modalidade" @if($inscricoes->count() <= 40) style="page-break-inside: avoid;" @endif>
                            ...
                            $inscricao->no_modalidade_concorrencia == 'AMPLA CONCORRÊNCIA' || $inscricao->no_modalidade_concorrencia == 'Ampla concorrência') Ampla concorrência / Ação afirmativa @else Ação afirmativa: {{$inscricao->cota->cod_novo}} - {{$inscricao->no_modalidade_concorrencia}} @endif</h4>
                            <table>
                                <thead>
                                    <tr class="esquerda">
                                        <th>Seq.</th>
