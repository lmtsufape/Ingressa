<div x-data>
    <input type="text" class="form-control campoDeTexto" placeholder="Procurar Candidato..."
        wire:model.debounce.500ms="texto" wire:keydown.escape="limpar" wire:keydown.tab="limpar"
        wire:keydown.enter="selecionarCandidato" @click.outside="if ($wire.texto != '') $wire.limpar()" />
    @if (!empty($texto))
