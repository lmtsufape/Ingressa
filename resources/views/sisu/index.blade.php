                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            @if ($sisu->caminho_import_regular != null)
                                                ...
                                                @if($sisu->chamadas->first() != null)
                                                    ...
                                                    <a href="{{route('exportar.dados.ingressantes.csv', $sisu->chamadas->first())}}" title ="Exportar dados dos ingressantes" class="text-decoration-none" style="cursor: pointer;">
                ...
                <div class="row justify-content-start">
                    <div class="col-md-12 shadow-sm p-2 px-3" style="background-color: white; border-radius: 00.5rem;">
                        ...
                        <ul class="list-group list-unstyled">
                            ...
                            <li>
                                <div title="Exportar dados dos ingressantes" class="d-flex align-items-center listagemLista my-1 pt-1 pb-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16">
                                        <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
                                    </svg>
                                    <div style="font-size: 13px;" class="tituloLista aling-middle mx-3">
                                        Exportar dados dos ingressantes
                                    </div>
                                </div>
                            </li>
                            <li>
                        ...
                        <div class="col-md-12 tituloModal">Deletar edição</div>
                            <div class="pt-3 pb-2 textoModal">
                                ...
                                <div class="row justify-content-between mt-4">
                                    ...
                                    <div class="col-md-4">
                                        <button type="submit" class="btn botaoVerde my-2 py-1 submeterFormBotao" form="deletar-sisu-form-{{$sisu->id}}" style="background-color: #FC605F;"><span class="px-4">Deletar</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 tituloModal">Editar edição</div>
                            <div class="pt-3 pb-2 textoModal">
                                ...
                                <div class="row justify-content-between mt-4">
                                    ...
                                    <div class="col-md-4">
                                        <button type="submit" class="btn botaoVerde my-2 py-1 submeterFormBotao" form="editar-sisu-form-{{$sisu->id}}"><span class="px-4">Editar</span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
