    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <a class="btn btn-warning" title="Listar candidatos da chamada" href="{{route('chamadas.candidatos', ['sisu_id' => $sisu->id, 'chamada_id' => $chamada->id])}}">
              ...
              <br>Listar por cursos</a>

            <a class="btn btn-warning" href="{{route('todos.ingressantes', ['sisu_id' => $sisu->id, 'chamada_id' => $chamada->id])}}">
